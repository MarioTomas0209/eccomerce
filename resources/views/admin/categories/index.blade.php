<x-admin-layout :breadcrumbs="[
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="text-right">
                                    ...
                                    <form action="{{ route('admin.categories.destroy', $item) }}" 
                                        method="POST"
                                        class="inline"
                                        onsubmit="return confirm('Are you sure you want to delete the category: {{ $item->name }}?');">
                                        @csrf
                                        @method('DELETE')
    ...
    @else
        <div class="flex items-center justify-center p-4 text-sm text-yellow-800 border border-yellow-300 rounded-lg bg-yellow-50"
            role="alert">
            ...
            <div>
                <span class="font-medium">No categories found!</span> Start by creating a new category.
            </div>
        </div>
    @endif
